...
module Create.Scene{
    export function Home(scenesManager) {
        ...
        var buttonsContainer: any = new Array();
    ...
    class Components {
        ...
        public static leftStage: any;
        public static buttonsStage: any;
        public static upFrame: any;
        public static char: any;
        public static informationPanel: any;
        public static scorePanel: any;
        public static settingsPanel: any;
        public static stagePanel: any;
        public static stagePanel2: any;
        public static sallySortie: any[] = new Array();
        public static backButton: any;
    }
    ...
    function createStagePanel2() {
        ...
        Components.stagePanel2.x = 1200;
        Components.stagePanel.addChild(Components.stagePanel2); Create.Component.decisionButton()
    }
    ...
    function createButtons(scenesManager) {
        ...
        var texture;
        var polys: any = new Array();
        var points: any = new Array();
        var points1: any = new Array();
    ...
    function createPlayerStatusText() {
        ...
        var playerStatusText = new PIXI.Text(
            '提督Level：'+
            GameParameters.Status.player['level']+'\n'+
            GameParameters.Status.player['name'],
            style0
        );
    ...
    function buttonActive(flag: boolean) {
    ...
    function animation() {
        if(GameParameters.Status.callAnimationId=='shutugeki')shutugeki();
        else if(GameParameters.Status.callAnimationId=='stageSelect')stageSelect();
        else if(GameParameters.Status.callAnimationId=='stageSelect2')stageSelect2();
        else if(GameParameters.Status.callAnimationId=='back')back();
    }
